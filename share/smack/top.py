...
def arguments():
  ...
  translate_group.add_argument('--wrapped-integer-encoding', action='store_true', default=False,
    help='enable wrapped integer arithmetic and signedness-aware comparison')
...
def llvm_to_bpl(args):
  ...
  if args.wrapped_integer_encoding: cmd += ['-wrapped-integer-encoding']
